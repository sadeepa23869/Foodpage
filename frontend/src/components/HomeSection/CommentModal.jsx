...
export default function CommentModal({ open, handleClose, post = {}, user = {} }) {
                        ...
                        <div className="flex justify-between items-center">
                            <div className="flex items-center space-x-2 cursor-pointer">
                                ...
                                <span className="text-gray-600">
                                    {post.userHandle} • {new Date(post.createdAt).toLocaleString()}
                                </span>
                            </div>
                        </div>
                        <div className="mt-2">
                                                    ...
                                                    >
                                                        {user?.id === comment.userId && (
                                                            <MenuItem onClick={handleEdit}>
                                                                <EditIcon sx={{ fontSize: "16px", color: "blue" }} />
                                                            </MenuItem>
                                                        )}
