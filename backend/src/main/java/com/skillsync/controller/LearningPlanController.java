...
public class LearningPlanController {
    ...
    @Autowired
    public LearningPlanController(LearningPlanService learningPlanService, JwtService jwtService,
    ...
    @PostMapping
    public ResponseEntity<LearningPlan> createLearningPlan(@RequestHeader("Authorization") String authHeader,
